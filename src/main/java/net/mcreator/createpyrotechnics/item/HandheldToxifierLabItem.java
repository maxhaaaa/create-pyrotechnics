...
import net.mcreator.createpyrotechnics.item.inventory.HandheldToxifierLabInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class HandheldToxifierLabItem extends Item {
	public HandheldToxifierLabItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Handheld Toxifier Lab");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new ToxifierLabMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new HandheldToxifierLabInventoryCapability();
	}
