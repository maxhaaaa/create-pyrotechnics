...
public class BombBenchMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BombBenchMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CreatePyrotechnicsModMenus.BOMB_BENCH.get(), id);
