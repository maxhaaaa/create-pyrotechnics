...
public class BevsslotsguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BevsslotsguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CreatePyrotechnicsModMenus.BEVSSLOTSGUI.get(), id);
