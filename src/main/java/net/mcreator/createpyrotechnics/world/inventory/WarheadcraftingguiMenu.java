...
public class WarheadcraftingguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WarheadcraftingguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CreatePyrotechnicsModMenus.WARHEADCRAFTINGGUI.get(), id);
