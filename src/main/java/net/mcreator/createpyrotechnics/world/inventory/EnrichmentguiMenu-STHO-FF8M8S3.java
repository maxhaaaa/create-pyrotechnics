...
public class EnrichmentguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EnrichmentguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CreatePyrotechnicsModMenus.ENRICHMENTGUI.get(), id);
