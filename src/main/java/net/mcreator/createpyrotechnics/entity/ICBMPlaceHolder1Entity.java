...
import net.mcreator.createpyrotechnics.procedures.OgMushroomCloudProcedure;
...
public class ICBMPlaceHolder1Entity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		OgMushroomCloudProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
