...
import net.mcreator.createpyrotechnics.procedures.AidsWhileProjectileFlyingTickProcedure;
...
public class AidsEntity extends AbstractArrow implements ItemSupplier {
	...
	public void tick() {
		super.tick();
		AidsWhileProjectileFlyingTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
		if (this.inGround)
			this.discard();
	}
