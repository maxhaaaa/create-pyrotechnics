...
public class PumpingButtonMessage {
	...
	public PumpingButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(PumpingButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(PumpingButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
