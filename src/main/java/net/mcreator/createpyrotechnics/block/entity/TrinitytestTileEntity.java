package net.mcreator.createpyrotechnics.block.entity;
...
public class TrinitytestTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TrinitytestTileEntity(BlockPos pos, BlockState state) {
		super(CreatePyrotechnicsModBlockEntities.TRINITYTEST.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(TrinitytestBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TrinitytestTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TrinitytestTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("trinitytest");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new TrinitytestguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
