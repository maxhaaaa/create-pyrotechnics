...
public class NuclearCoreTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public NuclearCoreTileEntity(BlockPos pos, BlockState state) {
		super(CreatePyrotechnicsModBlockEntities.NUCLEAR_CORE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(NuclearCoreBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<NuclearCoreTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<NuclearCoreTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("nuclear_core");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Nuclear Core");
	}
