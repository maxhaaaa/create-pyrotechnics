...
import net.mcreator.createpyrotechnics.procedures.ReturnVentProcedure;
import net.mcreator.createpyrotechnics.procedures.ReturnSealProcedure;
import net.mcreator.createpyrotechnics.procedures.ReturnPsiProcedure;
import net.mcreator.createpyrotechnics.network.PumpingButtonMessage;
...
public class PumpingScreen extends AbstractContainerScreen<PumpingMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				ReturnPsiProcedure.execute(entity), 84, 71, -12829636, false);
		...
		guiGraphics.drawString(this.font,
				...
				ReturnVentProcedure.execute(entity), 76, 87, -12829636, false);
		guiGraphics.drawString(this.font,

				ReturnSealProcedure.execute(entity), 62, 126, -12829636, false);
	}
