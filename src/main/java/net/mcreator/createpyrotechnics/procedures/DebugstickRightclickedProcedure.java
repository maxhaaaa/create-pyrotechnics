...
public class DebugstickRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, double intensity) {
		if (entity == null)
			return;
		...
		ExplodeandmotionProcedure.execute(world, x, y, z, intensity, 10);
	}
}
