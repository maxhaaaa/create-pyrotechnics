...
public class EnrichmentOnTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem() == Items.GLOWSTONE_DUST && ((new Object() {
			public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null)
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 2)).getItem() == Items.GOLD_NUGGET && new Object() {
		...
		if (new Object() {
			...
			if (new Object() {
				...
				if (new Object() {
					...
					}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == Items.MAGMA_CREAM) {
						{
							BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
							if (_ent != null) {
								final int _slotid = 1;
			...
			if (new Object() {
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						...
						}.getValue(world, BlockPos.containing(x, y, z), "timer") + 0.1));
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
			}
